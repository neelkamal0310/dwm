...
static const char *fonts[]          = { "Font Awesome 5 Free Solid:size=11:antialias=true:autohint=true",
                                        "Recursive:style=Sans Casual:size=13:antialias=true:autohint=true" };
static const char dmenufont[]       = "Recursive:style=Sans Casual:size=13";
...
static const char *dmenucmd[] = { "dmenu_run", "-bw", "0", "-g", "6", "-l", "15", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray1, NULL };
